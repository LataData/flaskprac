...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'powerpc64le-conda_cos7-linux-gnu-gcc -pthread -shared -Wl,-O2 '
              ...
              '-Wl,-rpath,/config/workspace/prac/venv/lib '
 ...
 'CONFIGURE_CFLAGS': '-mcpu=power8 -mtune=power8 -mpower8-fusion '
                     ...
                     '-fdebug-prefix-map=/opt/conda/conda-bld/python_1512347718438/work=/usr/local/src/conda/python-3.8.17 '
                     '-fdebug-prefix-map=/config/workspace/prac/venv=/usr/local/src/conda-prefix '
                     '-pipe    '
                     ' ',
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                      ...
                      '-Wl,-rpath,/config/workspace/prac/venv/lib '
                      '-L/config/workspace/prac/venv/lib',
 'CONFIG_ARGS': "'--prefix=/config/workspace/prac/venv' "
                ...
                "-I/config/workspace/prac/venv/include' "
                "'CPP=/config/workspace/prac/venv/bin/powerpc64le-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBFFI_INCLUDEDIR': '/config/workspace/prac/venv/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/config/workspace/prac/venv/lib/pkgconfig',
 'LIBPL': '/config/workspace/prac/venv/lib/python3.8/config-3.8-powerpc64le-linux-gnu',
