...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/config/workspace/prac/venv' "
                ...
                "-I/config/workspace/prac/venv/include' "
                "'CPP=/config/workspace/prac/venv/bin/aarch64-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBPL':
     '/config/workspace/prac/venv/lib/python3.8/config-3.8-aarch64-linux-gnu',
 ...
 'OPENSSL_INCLUDES': '-I/config/workspace/prac/venv/include',
 'OPENSSL_LDFLAGS': '-L/config/workspace/prac/venv/lib',
